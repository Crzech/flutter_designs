  ...
  Widget _botonesRedondeados() {
    return Table(
      children: [
        ...
        TableRow(
          children: [
            _crearBotonRedondeado(Colors.greenAccent, Icons.shop, "Buy"),
            _crearBotonRedondeado(Colors.orange, Icons.insert_drive_file,  "Drive")      
          ]
        ),
        TableRow(
          children: [
            _crearBotonRedondeado(Colors.blueAccent, Icons.movie_filter, "Enter"),
            _crearBotonRedondeado(Colors.pinkAccent, Icons.cloud, "Grocer")
          ]
        ),
        TableRow(
          children: [
